...
codes = {
    ...
    MONOCHROME_PALETTE   : load("monochrome-palette"),
    CGA_PALETTE          : load("cga-palette"),
    EGA_PALETTE          : load("ega-palette"),
    VGA_PALETTE          : load("vga-palette"),
}
# fmt: on
